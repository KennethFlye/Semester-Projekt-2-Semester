...
//	}
	...
	private void handleSearchDAyEvent() {
		...
		for (BookingTime element : bookedTimes) {
			dtm.addRow(new Object[] {element.getEventType().toString(), element.getStartTime().toString(), element.getFinishTime().toString()});
		} //TODO getEventType().getLabel() �ndret til -.toString() 
